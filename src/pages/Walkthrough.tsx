...
const sections: WalkthroughSection[] = [
  ...
  },
  {
    ...
    description:
      "Model relocation cost scenarios, compare them side-by-side, and optimize global mobility spend. Create individual simulations or group them (e.g. 'Singapore Office Expansion Q2') for batch analysis. Each simulation card shows origin → destination, total cost, per-year cost, and assignment duration.",
    features: [
  ...
  },
  {
    ...
    description:
      "Evaluate immigration, Schengen zone, and posted-worker compliance before business travel occurs. Each trip is assessed across multiple risk modules — immigration, tax withholding, social security, and permanent establishment — with traffic-light outcomes (Green / Amber / Red).",
    features: [
  ...
  },
  {
    ...
    description:
      "Central registry of all active employees with 334+ records. Filter and search by name, employee code, title, division, grade, or location. View compensation details including base salary, bonus percentage, and currency.",
    features: [
      ...
      "Link employees to simulations and trips",
  ...
  },
  {
    ...
    description:
      "Role-based access control (RBAC), user invitations, and activity monitoring. Four roles — Superadmin, Admin, Analyst, Viewer — each with distinct permission levels. Superadmins can impersonate users to see their experience.",
    features: [
  ...
  },
  {
    ...
    description:
      "Centralized data infrastructure comprising Calculations (formula-based cost computations with proration and step-down), Lookup Tables (reference data for countries, rates, allowances), Field Library (reusable field definitions), Field Mappings (source-to-target data transformations), and Data Sources (API connectors and rate files).",
    features: [
      ...
      "Data Sources for API connectors and rate files",
    ],
  ...
  },
  {
    ...
    title: "Configuration",
    description:
      "Platform-wide settings including general organization config, document templates (LOA, Balance Sheet, Pay Instructions, Cost Estimates), cost estimate template versioning, role & permission matrices, tax engine settings, organization (tenant) management, and a full audit log.",
    features: [
